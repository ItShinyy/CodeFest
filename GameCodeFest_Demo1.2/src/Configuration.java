...
public final class Configuration {
    ...
    public static final int STRONG_RANGED_WEAPON_SCORE = 800;
    public static final int MIN_WEAPONS_FOR_PVP = 3;
    ...
    // IMPROVEMENT: Added a base value for chests to use in efficiency calculations.
